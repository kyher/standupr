...
import ShowTeamSettingsController from '@/actions/App/Http/Controllers/Teams/Settings/ShowTeamSettingsController';
    ...
    >
        <div class="flex items-center justify-between">
            ...
            <Button v-if="team.role === 'admin'" variant="outline" as-child>
                <Link :href="ShowTeamSettingsController.url(team)">
                    Settings
                </Link>
            </Button>
        </div>
        ...
        <div class="mt-4 border-t pt-4">
            ...
            <div v-else class="flex flex-col gap-3">
                ...
                <Form
                    :action="StoreStandupController.url(team)"
                    method="post"
                    v-slot="{ processing }"
                >
